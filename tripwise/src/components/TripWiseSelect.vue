...
<div class="h-96 flex flex-col justify-between overflow-hidden">
  ...
  >
    <div v-show="!show" class="flex justify-between bg-gray-100 bg-opacity-75 rounded-md shadow-md px-4 py-5">
      <TripWiseDatePicker :startDate="modalData.data.flightStartAt" :endDate="modalData.data.flightEndAt" />
      <TripWiseLocationPicker :origin="modalData.data.origin" :destination="modalData.data.destination"/>
    </div>
  </Transition>
  <Transition
    name="custom-classes"
